export function parseBootstrapClassName(string: "small" | "medium" | "large"): string | undefined {
    switch (string) {
        case "small":
            return "btn-sm";
        case "medium":
...
export function modifyBootStrapButtonClassname(isOutline = false, actionType: ButtonActionTypes): string {
    switch (actionType) {
        case "primary":
